        ...
        <ul class="nav navbar-nav">
          <li><a href="admin"><span class="glyphicon glyphicon-home"></span></a></li>
            <div class="navbar-header">
               <a class="navbar-brand" >Road Ster</a>
            </div>
...
<c:if test="${!empty productList }">
	<table  class="table table-condensed" align="center">
			...
			<td align="center"><img src="<c:url value="resources/images/${product.id}.jpg" />"></td>
					<td align="center"><a href="<c:url value='product/edit/${product.id}' />"><button type="button" class="btn btn-success">Edit</button></a></td>
					<td align="center"><a href="<c:url value='product/remove/${product.id}' />"><button type="button" class="btn btn-danger">Delete</button></a></td>
				</tr>
			</c:forEach>
		</table>
	</c:if>
