...
<div class=row>
	...
	<div class="form-group col-md-6"> 
		...
		<input type="text" class="form-control" id="phone" name="phone" pattern=".{10}" required="true" title="id should be between 4 to 7 characters" placeholder="0123456789" >
	</div>
</div>
<div class=row>
...
<div class=row>	
	<div class="form-group col-md-6"> <!-- City-->
		...
		<input type="text" class="form-control" id="city_id" name="city" placeholder="Hyderabad">
	</div>									
					
	<div class="form-group col-md-6"> <!-- State Button -->
		<label for="state_id" class="control-label">State</label>
		<input type="text" class="form-control" id="city_id" name="city" placeholder="Telangana">
	</div>
	</div>
<div class=row>	
	<div class="form-group col-md-6"> <!-- Country Button -->
		<label for="state_id" class="control-label">Country</label>
		<input type="text" class="form-control" id="city_id" name="city" placeholder="India">
	</div>
